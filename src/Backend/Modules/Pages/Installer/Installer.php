    ...
    private function configureFrontendPages(): void
    {
        ...
        foreach ($this->getLanguages() as $language) {
            ...
            $this->insertPage(
                [
                    'id' => 3,
                    'title' => s($this->getLocale('PrivacyPolicy', 'Core', $language, 'lbl', 'Frontend'))->title()->toString(),
                    'type' => 'footer',
                    'language' => $language,
                ],
                ['seo_index' => 'noindex', 'seo_follow' => 'nofollow'],
            ...
            $this->insertPage(
                [
                    'id' => 4,
                    'title' => s($this->getLocale('CookiePolicy', 'Core', $language, 'lbl', 'Frontend'))->title()->toString(),
                    'type' => 'footer',
                    'language' => $language,
                ],
                ['seo_index' => 'noindex', 'seo_follow' => 'nofollow'],
