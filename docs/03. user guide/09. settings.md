...
**Functional cookies** is always ticked and greyed out — it covers what is strictly necessary for the site to function and does not require consent under GDPR.

The six optional levels you can enable are:
